...
namespace PixelCrushers.DialogueSystem {
	...
	public class DialogueSystemController : MonoBehaviour {
		...
		public static DialogueDatabase lastInitialDatabase = null;
		...
		public void PreloadResources() {
			...
			try {
				...
				ConversationModel model = new ConversationModel(databaseManager.MasterDatabase, databaseManager.MasterDatabase.conversations[0].Title, null, null, false, IsDialogueEntryValid);
