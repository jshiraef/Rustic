...
namespace PixelCrushers.DialogueSystem {
	...
	public static class DialogueLua {
		...
		/// Actor name.
		/// </param>
		/// <param name='conversantName'>
		/// Conversant name.
		/// </param>
		public static void SetParticipants(string actorName, string conversantName) {
			Lua.Run(string.Format("Variable[\"Actor\"] = \"{0}\"; Variable[\"Conversant\"] = \"{1}\"", new System.Object[] { DoubleQuotesToSingle(actorName), DoubleQuotesToSingle(conversantName) }), DialogueDebug.LogInfo);
		}
		...
		/// method leaves it as "WasDisplayed". The ConversationInterpreter marks entries as 
