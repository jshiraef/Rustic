...
namespace PixelCrushers.DialogueSystem.DialogueEditor {
	...
	public partial class DialogueEditorWindow {
		...
		public bool DrawDialogueEntryFieldContents() {
			...
			if (isStartEntry) {
				EditorGUILayout.HelpBox("This is the START entry. In most cases, you should leave this entry alone and begin your conversation with its child entries.", MessageType.Info);
			}

			// Description:
			var description = Field.Lookup(entry.fields, "Description");
			if (description != null) {
				description.value = EditorGUILayout.TextField(new GUIContent("Description", "Description of this entry; notes for the author"), description.value);
			}
