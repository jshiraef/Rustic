...
namespace PixelCrushers.DialogueSystem.Articy {
	...
	public static class ArticyTools {
		...
		public static string EnumValueToQuestState(int enumValue) {
			//--- articy now uses zero-based enum value, so values changed:
			switch (enumValue) {
			case 0: return QuestLog.StateToString(QuestState.Unassigned);
			case 1: return QuestLog.StateToString(QuestState.Active);
			case 2: return QuestLog.StateToString(QuestState.Success);
			case 3: return QuestLog.StateToString(QuestState.Failure);
			case 4: return QuestLog.StateToString(QuestState.Abandoned);
