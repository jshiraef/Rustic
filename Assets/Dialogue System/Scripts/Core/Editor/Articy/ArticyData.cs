...
namespace PixelCrushers.DialogueSystem.Articy {
	...
	public class ArticyData {
		...
		public class Dialogue : Element {
			...
			public Dialogue(string id, string technicalName, LocalizableText displayName, LocalizableText text, Features features, Vector2 position, List<Pin> pins, List<string> references)
				: base(id, technicalName, displayName, text, features, position) {
				this.pins = pins;
