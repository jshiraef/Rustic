...
namespace PixelCrushers.DialogueSystem.Articy {
	...
	public static class ArticySchemaTools {
		...
		public static ArticyData LoadArticyDataFromXmlFile(string xmlFilename, Encoding encoding) {
			if (Articy_2_4.Articy_2_4_Tools.IsSchema(xmlFilename)) {
				return Articy_2_4.Articy_2_4_Tools.LoadArticyData(xmlFilename, encoding);
			} else if (Articy_2_2.Articy_2_2_Tools.IsSchema(xmlFilename)) {
